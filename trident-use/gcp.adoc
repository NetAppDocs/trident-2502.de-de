...
Trident kann Cloud Volumes Service Volumes in einem von zwei link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["Servicetypen"^] erstellen:

* *CVS-Performance*: Der Standard-Trident-Servicetyp. Dieser leistungsoptimierte Servicetyp ist am besten für Produktions-Workloads geeignet, bei denen die Leistung im Vordergrund steht. Der CVS-Performance-Servicetyp ist eine Hardwareoption, die Volumes mit einer Mindestgröße von 100 GiB unterstützt. Es stehen folgende Auswahlmöglichkeiten zur Verfügung link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["Drei Service-Level"^]:
+
** `standard`
** `premium`
** `extreme`
...
* *CVS*: Der CVS-Diensttyp bietet hohe zonale Verfügbarkeit bei begrenzten bis mittleren Leistungsstufen. Der CVS-Diensttyp ist eine Softwareoption, die Speicherpools nutzt, um Volumes ab 1 GiB zu unterstützen. Der Speicherpool kann bis zu 50 Volumes enthalten, wobei alle Volumes die Kapazität und Leistung des Pools gemeinsam nutzen. Es stehen folgende Auswahlmöglichkeiten zur Verfügung link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["Zwei Service-Level"^]:
+
** `standardsw`
...
.Was Sie benötigen
Zur Konfiguration und Nutzung des  https://www.netapp.com/google-cloud/netapp-volumes/["Cloud Volumes Service für Google Cloud"^] Backends werden folgende Voraussetzungen benötigt:
