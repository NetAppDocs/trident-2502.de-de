...
Mit dem [`tridentctl`-Dienstprogramm kann der  `get`-Befehl ausgeführt werden, um untergeordnete Volumes abzurufen. Weitere Informationen sind unter link:../trident-managing-k8s/tridentctl.html[`tridentctl` (Befehle und Optionen) verfügbar.
