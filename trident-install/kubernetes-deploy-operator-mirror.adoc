...
.Bevor Sie beginnen
Melden Sie sich beim Linux-Host an, und überprüfen Sie, ob er ein funktionierendes System verwaltet und link:requirements.html["Unterstützter Kubernetes-Cluster"^]dass Sie über die erforderliche Privileges verfügen.
