...
.Bevor Sie beginnen
Zusätzlich zu dem link:trident-install/kubernetes-deploy.html#before-you-deploy["Voraussetzungen für die Implementierung"] benötigen Sie link:https://v3.helm.sh/["Helm Version 3"^].
