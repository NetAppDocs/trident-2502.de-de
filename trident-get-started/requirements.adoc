...
* Lokale FAS, AFF oder ASA r2 (iSCSI, NVMe/TCP und FC) mit ONTAP-Versionen unter NetApp voller oder eingeschränkter Unterstützung. Siehe link:https://mysupport.netapp.com/site/info/version-support["Unterstützung Der Softwareversion"].
