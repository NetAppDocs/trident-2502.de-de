...
summary: 'Die Bucket Custom Resource (CR) für Trident Protect wird als AppVault bezeichnet. AppVaults sind die deklarative Kubernetes-Workflow-Repräsentation eines Speicher-Buckets.' 
---
