...
summary: 'Trident Protect nutzt das Kubernetes-Modell der rollenbasierten Zugriffskontrolle (RBAC). Mit den RBAC-Funktionen von Trident Protect können Sie den Zugriff auf Ressourcen präziser steuern.' 
---
