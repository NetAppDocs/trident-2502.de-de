...
NOTE: Den aktuellen Trident Supportplan für die Trident-Version finden Sie unter  https://docs.netapp.com/us-en/trident/get-help.html#trident-support-lifecycle["Support-Lebenszyklus-Seite"^].
